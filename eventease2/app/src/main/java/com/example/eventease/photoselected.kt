...
class photoselected: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val names= arrayOf(
            "Anjali Jaanva", "Jaladhija Kakad","Shubh Upreta",
            "Sudhanshi Sinha", "Shubhanshi Verma","Vrushali Chawla"
        )
        val venues= arrayOf(
            "Jaipur", "Shimla","Himanchal",
            "Ranchi", "Indore","Chandigarh"
        )

        val emails= arrayOf(
            "anjali@gmail.com", "jala@gmail.com","shubh@gmail.com",
            "sudhi@gmail.com", "shubhi@gmail.com","vrush@gmail.com"
        )
        ...
        listview.setOnItemClickListener { _, _, position, id ->
            ...
            i.putExtra("booking","PHOTOGRAPHY")
